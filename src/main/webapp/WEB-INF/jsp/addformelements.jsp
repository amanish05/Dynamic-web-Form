...
<form class="form-horizontal" action="adminpage.html" method="post">
 <div class="form-group">
    <label for="formMame" class="col-sm-2 control-label">Form Name:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" 
      	     id="formMame" placeholder="Enter Form Name"
      	     name="formMame">
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" 
      	     id="pageNumber" placeholder="Enter Page Number"
      	     name="pageNumber">
    </div>
  </div>
  <div class="form-group">
  <label for="pageNumber" class="col-sm-2 control-label">Select Form Element:</label>
    <div class="col-sm-10">
