...
INSERT INTO FormElement(id, form_Id, name, title, value)
VALUES(1, 1, 'name', 'NAME OF APPLICANT (Last, First, Middle):', 'Trump, Donald, John');

-- 2. DateText for Date of Birth
INSERT INTO FormElement(id, form_Id, name, title, date_format, value)
VALUES(2, 1, 'date', 'DATE OF BIRTH (Mo./Day/Year):', 'mm/dd/yyyy', '06/14/1946');

-- 3. Text Box for Place of Birth
INSERT INTO FormElement(id, form_Id, name, title, value)
VALUES(3, 1, 'placeOfbirth', 'PLACE OF BIRTH (City and Country):', 'New York, United States of America');

-- 4. Text Box for Nationality
INSERT INTO FormElement(id, form_Id, name, title, value)
VALUES(4, 1, 'nationality', 'NATIONALITY:', 'American');
