		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="registernewuser.html">Register
							New User</a></li>
				</ul>
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="middleName"
					placeholder="Enter Your Middle Name" name="middleName">
			</div>
		</div>
		<div class="form-group row">
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="password" class="form-control" id="confirmPassword"
					placeholder="Confirm Your Entered Password" name="confirmPassword">
			</div>
		</div>
		<h4>
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="house"
					placeholder="Enter Your House Number" name="house">
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="street"
					placeholder="Enter Your Street Number" name="street">
			</div>
		</div>
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="area"
					placeholder="Enter Your Area" name="area">
			</div>
		</div>
		<div class="form-group row">
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="zip"
					placeholder="Enter Your Zip Code" name="zip">
			</div>
		</div>
